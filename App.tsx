        ...
        <nav className="fixed top-0 left-0 right-0 h-16 border-b border-gray-100 bg-white/95 backdrop-blur-sm z-40 flex items-center justify-between px-8">
          ...
          <div className="flex items-center gap-8">
            ...
            {user.isLoggedIn ? (
              <div className="flex items-center gap-6">
                ...
                <button
                  ...
                  className="text-[10px] font-black uppercase hover:text-black"
                >
                  Sign Out
                </button>
              </div>
              ...
              <button
                ...
                className="text-[10px] font-black uppercase hover:text-gray-500"
              >
                Log In
              </button>
            )}
            ...
            <button
              ...
              className="p-2 hover:bg-gray-100 rounded-lg border border-gray-100"
            >
              <svg
