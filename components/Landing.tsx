...
const Landing: React.FC<LandingProps> = ({ onProcess }) => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-6 bg-white">
      <div className="w-full max-w-5xl text-center">
        <span className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.4em] mb-4 block">Executive Assistant</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-12 border-t border-gray-100 opacity-60">
          <div className="flex flex-col items-center gap-3">
            ...
            <div className="text-center">
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-900">Direct BLUF</h4>
            </div>
          </div>
          <div className="flex flex-col items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600">
            ...
            <div className="text-center">
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-900">Task Extraction</h4>
            </div>
          </div>
          <div className="flex flex-col items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600">
            ...
            <div className="text-center">
              <h4 className="text-[10px] font-bold uppercase tracking-widest text-gray-900">Polished Output</h4>
            </div>
          </div>
        </div>
      </div>
